[DONE] Exercise 5.5e: fix the latex error in the last phrase, which currently has an
...
[DONE] 5.47: Rework the inductive step using the exact definition in 1.11iii; that is,
