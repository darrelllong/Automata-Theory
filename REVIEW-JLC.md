...
6.39a: Keep the current illustrative solution, but also observe that there is
a shorter expression with a simpified right-hand term.

6.40, 6.41: Keep the existing 'solution by substitution' as an alternate method,
but first:
...
6.48e: Correct the expression by eliminating the empty string from the
displayed solution.

6.50: Show how the answers given in all seven parts of this exercise came about.
