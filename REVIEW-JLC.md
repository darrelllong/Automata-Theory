[DONE] 1.8: The given solution is actually for Exercise 1.9, so label it correctly.
...
[DONE] 8.38c: My original request resulted in no change.  Think harder about this:
...
[DONE] 9.19: Restore the observation that |s| = 4n+1 .

[DONE] 9.28: Precede the first sentence with "Determine if "

[DONE] 9.29: The 'Disproof' contains an unspecified n, allowing a^nb^n to be
interpreted as a single word.  Replace this paragraph with an actual
counterexample.  (And retain the second paragraph as well.)

[DONE] 9.30a: The exercise explicitly asks for a proof involving a two-letter
alphabet.  Using three letters (a,b,c) does not fit that constraint.  Revise.

[DONE] 9.33: Leave the given solution unchanged, but revise the ch-09.tex problem
to use the directive 'Prove or disprove'.

[DONE] 9.35: {a^nb^n} needs 'n' to be qualified, so that it doesn't appear to be
