...
\textit{Step}: Let $x=ay$ with $|y|=n$. This is the tail-recursive form of
Definition~1.11iii. Using that definition at the beginning and end, together
with the induction hypothesis for the state $\delta(s,a)$ and the string $y$,
...
\textit{Step}: Let $x=ay$. By the tail-recursive clause in Definition~1.11iii,
\[
