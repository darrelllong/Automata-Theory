...
\item Homomorphism: $\psi([\lambda]_{R^A})=s_0$. $\psi([xa]_{R^A})=\DBAR(s_0,xa)=\delta(\DBAR(s_0,x),a)=\delta(\psi([x]_{R^A}),a)$. $[x]\in F_{R^A}\Leftrightarrow x\in L(A)\Leftrightarrow\DBAR(s_0,x)\in F\cap S^c=F^c$. \checkmark
