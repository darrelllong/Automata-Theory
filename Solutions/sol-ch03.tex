...
\item To show this is well defined, first note that it is defined everywhere because $A$ is connected, so every state $s\in S_A$ has at least one string reaching it. Now suppose $x$ and $y$ both satisfy
