...
\textit{Step}: $x=ya$, $|y|=n$. Using Definition 1.11iii at the beginning and end, together with the homomorphism property $\mu(\delta(t,a))=\delta_{R_L}(\mu(t),a)$,
\[
...
\textit{Step}: $x=ya$. By Definition 1.11iii,
\[
