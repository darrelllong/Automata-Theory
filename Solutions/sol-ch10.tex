...
\]
$B$ is context free. A word $x\pmb{\$}$ is in $F(B)$ exactly when $x\not in K$, because it fails to be maximal precisely when it can be extended to $x\pmb{\$\$}$. Therefore
\[
