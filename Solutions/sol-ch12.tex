...
\begin{enumerate}
\item \textbf{$N\in\TSIG$}: No. $N = \overline{E}$ (complement of $E$ from Exercise 12.41). Since $E\in\TSIG$ but $E\not in\OSIG$, the complement $N = \overline{E}\not in\TSIG$ (if $E\in\TSIG$ and $\overline{E}\in\TSIG$, then $E$ would be recursive, contradicting $E\not in\OSIG$). So $N\not in\TSIG$.
