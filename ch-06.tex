...
Let $\Sigma = \{\pmb{a},\pmb{b},\pmb{c}\}$. The following languages are all
regular sets:
...
\end{tabular}\end{center}
An analogous technique can be used to eliminate variables when there is a larger
...
interrelated. Recall that, for a state $s_i$, $I(A,s_i)$ is composed of strings
