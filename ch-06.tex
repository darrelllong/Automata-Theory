...
Let $\Sigma = \{\pmb{a},\pmb{b},\pmb{c}\}$. Each of the following languages \textcolor{red}{are}
regular sets:
...
\textbf{Notational Convention}: The precedence of the operators, from highest to
...
% Figure 6.1
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig6-1.eps}}
\caption{NDFAs which recognize regular expressions with zero operators}\label{fig-6.1}
\end{figure}

% Figure 6.2
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-2.eps}}
...
% Figure 6.3
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-3.eps}}
...
% Figure 6.4
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig6-4.eps}}
...
Now let us assume that $\lambda \not in A$ and that we have a solution $W$ that
...
$z$. Thus $z \in W$ and $z \not in A^*E$, and since $E \subseteq A^*E$ (why?),
$z \not in E$. Since $W$ is a solution, we have
\begin{center}\begin{tabular}{rcl}
...
\end{tabular}\end{center}
in which $(\forall i,j \in \{1,2, \cdots ,n\})(\lambda \textcolor{red}{\not in} A_{ij})$.
\begin{enumerate}[a.]
...
(\pmb{b}\cdot(\pmb{a}\cup\pmb{bb})^*) = \pmb{b} \cdot (\pmb{a}\cup\pmb{bb})^*$\textcolor{red}{ .}
...
% Figure 6.5
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-5.eps}}
...
% Figure 6.6
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-6.eps}}
...
% Figure 6.7
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-7.eps}}
...
% Figure 6.8
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-8.eps}}
...
% Figure 6.9
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-9.eps}}
...
% Figure 6.10
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-10.eps}}
...
$X_1$ (instead of $X_2$)\textcolor{red}{ .} The solution for $X_2$ is quite concise, which leads
...
interrelated. Recall that, for a state $s_i$, $I(A,s_i)$ is \textcolor{red}{comprised of} strings
...
\textbf{\Index{Kleene's Theorem}}. Let $\Sigma$ be an alphabet. Then $\RSIG = \DSIG$.
...
% Figure 6.11
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig6-11.eps}}
...
% Figure 6.12
\begin{figure}
\centerline{\includegraphics[width=4.5in]{ToFAfigures/fig6-12.eps}}
...
% Figure 6.13
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig6-13.eps}}
...
\item Let $\Sigma$ be an alphabet, and let $s:\ \Sigma \rightarrow \wp(\Gamma^*)$
be a regular set substitution.
\begin{enumerate}
...
% Figure 6.14
\begin{figure}
\centerline{\includegraphics[width=6.2in]{ToFAfigures/fig6-14.eps}}
