...
composed of the familiar components that have already been used
...
% Figure 11.1
\begin{figure}[tbh]
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-1.eps}}
\caption{A model of a Turing machine.}\label{fig-11.1}
\end{figure}
...
% Figure 11.2
\begin{figure}
\centerline{\includegraphics[width=2.4in]{ToFAfigures/fig11-2.eps}}
...
Turing machine may be composed of several submodules. Control may be passed to
...
% Figure 11.3
\begin{figure}
\centerline{\includegraphics[width=2.4in]{ToFAfigures/fig11-3.eps}}
...
% Figure 11.4
\begin{figure}
\centerline{\includegraphics[height=3.4in]{ToFAfigures/fig11-4.eps}}
...
% Figure 11.5a
\begin{figure}
\centerline{\includegraphics[height=4.0in]{ToFAfigures/fig11-5a.eps}}
\caption{The Turing machine discussed in Example 11.4}\label{fig-11.5a}
\end{figure}

% Figure 11.5b
\begin{figure}
\centerline{\includegraphics[height=1.2in]{ToFAfigures/fig11-5b.eps}}
\caption{Submachine $S_1$ in Example 11.4}\label{fig-11.5b}
\end{figure}

% Figure 11.5c
\begin{figure}
\centerline{\includegraphics[height=1.2in]{ToFAfigures/fig11-5c.eps}}
...
% Figure 11.6
\begin{figure}
\centerline{\includegraphics[width=2.4in]{ToFAfigures/fig11-6.eps}}
...
would contain the original symbols, and the upper track may or may not have a
...
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-7.eps}}
...
% Figure 11.8
\begin{figure}
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-8.eps}}
...
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-9.eps}}
\caption{A three-tape Turing machine}\label{fig-11.9}
\end{figure}

% Figure 11.10
\begin{figure}
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-10.eps}}
...
resulting in a $\pmb{Y}$ exists, and there are infinitely many negative
...
% Figure 11.11
\begin{figure}
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-11.eps}}
...
% Figure 11.12
\begin{figure}
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-12.eps}}
...
% Figure 11.13
\begin{figure}
\centerline{\includegraphics[height=3.8in]{ToFAfigures/fig11-13.eps}}
...
\renewcommand{\theHfigure}{\arabic{chapter}.14\alph{figure}}
% Figure 11.14a
\begin{figure}
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-14a.eps}}
\caption{A three-track Turing machine employing delimiters}\label{fig-11.14a}
\end{figure}

% Figure 11.14b
\begin{figure}
\centerline{\includegraphics[width=3.4in]{ToFAfigures/fig11-14b.eps}}
...
% Figure 11.15
\begin{figure}
\centerline{\includegraphics[height=3.8in]{ToFAfigures/fig11-15.eps}}
...
symbols can be placed. Furthermore, only a finite number of characters
...
bounded automata were shown to recognize exactly the type 1 languages and
...
\item Show that any Turing machine $A_3$ accepting $L=L_3(A_3)$ has an
equivalent Turing machine $A_1$ for which $L=L_1(A_1)$ by explicitly modifying
the quintuple for $A_3$ and proving that your construction behaves as desired.
\end{enumerate}
