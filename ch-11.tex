...
\textcolor{red}{comprised of} the familiar components that have already been used
...
Turing machine may be \textcolor{red}{comprised of} several submodules. Control may be passed to
...
resulting in a $\pmb{Y}$ exists, and there \textcolor{red}{are} an infinite number of negative
...
symbols can be placed. Furthermore, there \textcolor{red}{are} only a finite number of characters
...
\section{Closure Properties and \textcolor{red}{The} Hierarchy Theorem}\label{sec-11.4}
