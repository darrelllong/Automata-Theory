...
$\NN$ is not closed under $\sqrt{\phantom{x}}$ (square root) since $7 \in \NN$ but
$\sqrt{7} \notin \NN$.
...
$\DBAR(s_0,x) \not in F$ & $\Leftrightarrow$ &
	(by definition of $L$) \\
$x \not in L(A)$ & $\Leftrightarrow$ &
	(by definition of $K$) \\
$x \not in K$ & $\Leftrightarrow$ &
	(by definition of complement) \\
$x \in\ \sim   K$ &&
\end{tabular}
\end{center}
...
% Figure 5.1
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig5-1.eps}}
\caption{The two automata discussed in Example 5.6}\label{fig-5.1}
\end{figure}

% Figure 5.2
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig5-2.eps}}
...
% Figure 5.3
\begin{figure}
\centerline{\includegraphics[height=3.6in]{ToFAfigures/fig5-3.eps}}
...
% Figure 5.4
\begin{figure}
\centerline{\includegraphics[height=3.6in]{ToFAfigures/fig5-4.eps}}
...
% Figure 5.5
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-5.eps}}
\caption{Two candidates for concatenation}\label{fig-5.5}
\end{figure}

% Figure 5.6
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-6.eps}}
...
% Figure 5.7
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-7.eps}}
\caption{A pair of candidates for concatenation}\label{fig-5.7}
\end{figure}

% Figure 5.8
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-8.eps}}
...
% Figure 5.9
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-9.eps}}
...
% Figure 5.10
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-10.eps}}
...
% Figure 5.11
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-11.eps}}
...
% Figure 5.12
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-12.eps}}
...
\emph{Proof.} Let \textcolor{red}{L} belong to $\DSIG$. Then there is a \underline{non}deterministic
...
% Figure 5.13
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig5-13.eps}}
\caption{The NDFA $B$ in Example 5.16.}\label{fig-5.13}
\end{figure}

% Figure 5.14
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig5-14.eps}}
...
For any alphabet $\Sigma$, $\DSIG$ is closed under the operator \textcolor{red}{Z},
where \textcolor{red}{Z} is defined by
\[ Z(L) = \{x \ |\  x \text{ is formed by deleting zero or more letters from a
	word in \textcolor{red}{L}}\}. \]
...
% Figure 5.15
\begin{figure}
\centerline{\includegraphics[width=5in]{ToFAfigures/fig5-15.eps}}
\caption{The automaton $C$ discussed in Example 5.17}\label{fig-5.15}
\end{figure}

% Figure 5.16
\begin{figure}
\centerline{\includegraphics[width=5in]{ToFAfigures/fig5-16.eps}}
\caption{An automaton accepting $Z(C)$ in Example 5.17}\label{fig-5.16}
\end{figure}

% Figure 5.17
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig5-17.eps}}
...
% Figure 5.18
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig5-18.eps}}
...
$L_1 \cap L_2 = \emptyset \not in \mathfrak{N}_{\{\pmb{a},\pmb{b}\}}$ (why?).
\end{lmm}
...
$K=\{\lambda,\pmb{ab},\pmb{bb}\}$, $\PBAR(K)=\{\lambda,\pmb{cdd},\pmb{dd}\}$,
...
alphabet. If $\mu$ is defined by $\mu(() =$ \textbf{begin} and $\mu())=$ \textbf{end},
then the set $M$ of all strings of matched parentheses maps to $K$, the set of
all matched \textbf{begin}-\textbf{end} pairs.
...
different alphabets, if $L$ is FAD, the homomorphic image of \textcolor{red}{L} is also FAD (see
the exercises).
...
% Figure 5.19
\begin{figure}
\centerline{\includegraphics[width=5.5in]{ToFAfigures/fig5-19.eps}}
...
% Figure 5.20
\begin{figure}
\centerline{\includegraphics[width=5.5in]{ToFAfigures/fig5-20.eps}}
...
$z \in\Gamma^*$\textcolor{red}{, The} \emph{\Index{inverse homomorphic image} of \textcolor{red}{z} under $\PBAR$}
is then
\[ \overline{\psi^{-1}}(z)=\{x \in \Sigma^*\ |\ \PBAR(x) = z\} \]
For a language $L \subseteq \Gamma^*$, the \emph{\Index{inverse homomorphic
image} of \textcolor{red}{L} under} $\PBAR$ is defined by
...
% Figure 5.21
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig5-21.eps}}
...
\emph{Proof.} Let $L=\{\pmb{a}^n\pmb{b}^n \mid n \geq 0\}\in \NSIG$. Then $L^b=\{\pmb{a}^n \mid n\geq 0\}
\notin \NSIG$.
\end{lmm}

Other examples that show \NSIG\ is not closed under the operator $b$ abound. If
$K=\{x\in\{\pmb{a},\pmb{b}\}^* \mid \ |x|_{\pmb{a}} = |x|_{\pmb{b}}\}$, then
...
$L_2$, written $L_1/L_2$, is defined by $L_1/L_2 =\{x \mid \exists y \in \Sigma^* \ni
...
final state from $t$. That is, $F^/=\{t \mid \exists y \in \Sigma^*\ni (y \in L_2
\wedge \DBAR_1(t,y) \in F)\}$. It can be shown that $A^/$ does indeed accept
...
exactly, since there \textcolor{red}{are} only a finite number of ways to choose a set of final
...
$L^r=\{x^r \mid x \in L\}$. Note that the (unary) reversal operator $r$ is thus defined
...
$B(L)=\{z\  \mid (\exists x\in L)(\exists y \in \Sigma^*)(z = xy)\}$.
\begin{enumerate}
\item Given an automaton accepting $L$, describe how to modify it to produce an
...
\item Let $\Sigma$ be an alphabet. Define
$M(L)=\{z\  \mid (\exists x \in L)(\exists y \in \Sigma^+)(z = xy)\}$.
\begin{enumerate}
\item Given an automaton accepting $L$\textcolor{red}{. describe} how to modify it to produce an
...
\item Let $W(L)=\{x\  \mid x$ is formed by deleting one or more letters from a word
in L$\}$.
\begin{enumerate}
\item Given an automaton accepting $L$, describe how to modify it to produce an
...
\item Let $V(L)=\{x  \mid x$ is formed by deleting the odd-positioned letters from a
...
\item Let $U(L)=\{x\  \mid x$ is formed by deleting the even-positioned letters from
...
\item Let $T(L)=\{x\  \mid x$ is formed by deleting every third, sixth, ninth, and so
...
let $P=\{x\in\Sigma^* \mid |x|$ is prime$\}$ and let $I(L)$ be defined by
$I(L) = L \cap P$.
\begin{enumerate}
...
give an algorithm for computing $F^{^/}=\{t \mid \exists y \in \Sigma^* \ni (y \in L_2
