...
% Figure 9.1
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-1.eps,width=5.5in}}
...
% Figure 9.2
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-2.eps,width=4.5in}}
...
freedom in the {\em order} in which the associated productions are applied.

% Figure 9.3
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-3.eps,width=6.0in}}
...
% Figure 9.4
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-4.eps,width=6.0in}}
...
% Figure 9.5
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-5.eps,height=5.5in}}
...
\<identifier\> & $\pmb{d}$
\end{tabular}\end{center}
$L(G_s)$ then contains the string $\pmb{a-b-c}$, which can be generated by
...
commutative operation, and the expression $(b-c)-d$ will usually produce a
different value than $b-(c-d)$. Ambiguity can thus be a fatal flaw in a grammar
describing a programming language.

% Figure 9.6
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-6.eps,height=6.5in}}
\caption{(a) A parse tree for $\pmb{a-b-c}$ in Example 9.6 (b) An alternate
parse tree for $\pmb{a-b-c}$}\label{fig-9.6}
\end{figure}
...
% Figure 9.7
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-7.eps,height=3.5in}}
...
% Figure 9.8
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-8.eps,width=5.0in}}
...
% Figure 9.9
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-9.eps,height=7.5in}}
...
% Figure 9.10
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-10.eps,height=3.7in}}
...
\centerline{\epsfig{figure=ToFAfigures/fig9-11.eps,width=4.7in}}
...
% Figure 9.12
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig9-12.eps,height=3.7in}}
...
\notin L)$ \\
{\bf then} $L$ is {\bf not} context free.
...
thus $uv^2wx^2y \notin L$. If $v$ were, say, all $\pmb{b}$s and $x$ were all ${\pmb
