...
The rank of the relation in Example 2.3 was 2, since there were two equivalence
...
most one equivalence class per state, and there are finitely many states,
...
either (both $z \in L$ and $y \in L$) or (neither $z$ nor $y$ belongs to $L$)
...
since there are infinitely many primes). Let $x=\pmb{a}^p\pmb{b}^{(p-1)!}$.
