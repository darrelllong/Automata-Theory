...
% Figure 10.1
\begin{figure}
\centerline{\includegraphics[height=2.5in]{ToFAfigures/fig10-1.eps}}
...
% Figure 10.2
\begin{figure}
\centerline{\includegraphics[height=1in]{ToFAfigures/fig10-2.eps}}
...
\renewcommand{\theHfigure}{\arabic{chapter}.3\alph{figure}}
% Figure 10.3a
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-3a.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.1}\label{fig-10.3a}
\end{figure}

% Figure 10.3b
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-3b.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.1}\label{fig-10.3b}
\end{figure}

% Figure 10.3c
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-3c.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.1}\label{fig-10.3c}
\end{figure}

% Figure 10.3d
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-3d.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.1}\label{fig-10.3d}
\end{figure}

% Figure 10.3e
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-3e.eps}}
...
\renewcommand{\theHfigure}{\arabic{chapter}.\arabic{figure}}
...
% Figure 10.4
\begin{figure}
\centerline{\includegraphics[height=3.0in]{ToFAfigures/fig10-4.eps}}
\caption{The PDA discussed in Example 10.5}\label{fig-10.4}
\end{figure}

Since $A$ was the only stack symbol in $P_3$, the language could \textcolor{red}{have as easily}
...
where $\delta_G$ is \textcolor{red}{comprised of} the following nonempty transitions:
\begin{center}\begin{tabular}{r@{ = }l}
...
Figures \ref{fig-10.5a}-f \textcolor{red}{illustrates} the state of the machine at several points during the
...
\renewcommand{\theHfigure}{\arabic{chapter}.5\alph{figure}}
% Figure 10.5a
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-5a.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.7}\label{fig-10.5a}
\end{figure}

% Figure 10.5b
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-5b.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.7}\label{fig-10.5b}
\end{figure}

% Figure 10.5c
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-5c.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.7}\label{fig-10.5c}
\end{figure}

% Figure 10.5d
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-5d.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.7}\label{fig-10.5d}
\end{figure}

% Figure 10.5e
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-5e.eps}}
\caption{Walkthrough of the pushdown automaton discussed in Example 10.7}\label{fig-10.5e}
\end{figure}

% Figure 10.5f
\begin{figure}
\centerline{\includegraphics[height=2.0in]{ToFAfigures/fig10-5f.eps}}
...
the first \textcolor{red}{criteria} for productions. Since $\delta(t,\pmb{a},S)$ contains
...
rule due to the second \textcolor{red}{criteria} arises because $\delta(t,\pmb{a},S)$ contains
...
from the first \textcolor{red}{criteria} for productions. The transition $\delta(q,\pmb{a},B) =
\{\langle q,A\rangle\}$ accounts for the productions $B^{qr}\rightarrow\pmb{a}
A^{qr}$ and $B^{qq}\rightarrow\pmb{a}A^{qq}$\textcolor{red}{ .} $\delta(q,\pmb{a},A)=\{\langle q,
AA\rangle\}$ gives rise to the $A^{qq}$ -rules $A^{qq}\rightarrow\pmb{a}A^{qq}A^{qq}$ and $A^{qq}\rightarrow\pmb{a}A^{qr}A^{rq}$, as well as $A^{qr}$ -rules
...
Note that some of the potential nonterminals ($B^{qr}\textcolor{red}{ ,}B^{rq}\textcolor{red}{ ,}B^{rr}$) are never
generated, and others ($A^{qq}\textcolor{red}{ ,}B^{qq}$) cannot produce terminal strings. The
...
\pmb{aaabbb}$. $A^{rr}$\textcolor{red}{ ,} by contrast, denotes a nonterminal (again corresponding
...
\section{Equivalence \textcolor{red}{Of} Acceptance By Final State and Empty Stack}\label{sec-10.3}

In this section, we explore the ramifications of accepting words according to
the \textcolor{red}{criteria} that a final state can be reached after processing all the letters
on the input tape, rather than the \textcolor{red}{criteria} that the stack is emptied. Theorem
...
\not in\Gamma$ and a new state $e$ such that $e \not in S$, and let $P_{\lambda}=
...
\item $(\forall \pmb{a}\in\Sigma)(\forall A\in\Gamma)(\forall s\in S)(\delta_{\lambda}
...
% Figure 10.6
\begin{figure}
\centerline{\includegraphics[height=3.0in]{ToFAfigures/fig10-6.eps}}
...
$((\langle s_1,xy,\alpha\rangle)\Dvdash\langle t_1,y,\beta\rangle\text{ in }
...
is not closed under union if $\Sigma$ is \textcolor{red}{comprised of} at least two symbols
...
Let $\Sigma$ be an alphabet \textcolor{red}{comprised of} at least two symbols. Then \ASIG\ is
...
\item Prove or disprove that $\{x\in\{\pmb{a},\pmb{b},\pmb{c}\}^*|\ \ |x|_{\pmb{a}}=|x|_{
\pmb{b}}=|x|_{\pmb{c}}\}$ is not context free. [\emph{Hint:} Use closure properties and apply
part (a).]
\end{enumerate}
