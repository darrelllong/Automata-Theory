...
% Figure 4.1
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-1.eps,width=3in}}
...
% Figure 4.2
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-2.eps,width=3in}}
...
% Figure 4.3
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-3.eps,width=4in}}
...
% Figure 4.4
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-4.eps,width=3in}}
...
t & $\emptyset$ & $\{t\}$
\end{tabular}\end{center}
\centerline{\epsfig{figure=ToFAfigures/fig4-5.eps,width=2.5in}}
...
% Figure 4.6
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-6.eps,width=6.5in}}
...
\emph{destinations} (rather than recording all the paths). Still, in an
...
% Figure 4.7
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-7.eps,width=2.8in}}
...
deterministic finite automaton can grow exponentially larger as the number of
...
% Figure 4.8
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-8.eps,width=2.5in}}
...
% Figure 4.9
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-9.eps,width=6in}}
...
a machine that would accept the reverse of this language, that is, to accept
$L'=\{x \in \{\pmb{a},\pmb{b}\}^*|\ x$ ends with $\pmb{a}\vee x$ contains
...
% Figure 4.10
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-10.eps,width=3.5in}}
\caption{An NDFA accepting the language given in Example 4.10}\label{fig-4.10}
\end{figure}

It can be shown that the technique employed in Example 4.10, when applied to any
...
% Figure 4.11
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-11.eps,width=3.5in}}
...
% Figure 4.12
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-12.eps,width=6.5in}}
...
% Figure 4.13
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-13.eps,width=6.5in}}
...
% Figure 4.15
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-14.eps,width=6.5in}}
...
% Figure 4.16
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-16.eps,width=2.5in}}
\caption{The NDFA discussed in Example 4.13}\label{fig-4.16}
\end{figure}
% Figure 4.17
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-17.eps,width=2.5in}}
...
$t_l$ & $t_2$ & $a_1$ & $a_2$ & $t'_1$ & $t'_2$ & {\bf accept} \\
\hline
...
$\Sigma$, will not change this; both $t_1$ and $t_2$ remain $\pmb{0}$. The one
...
% Figure 4.18
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-18.eps,width=6in}}
...
% Figure 4.19
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-19.eps,width=3.5in}}
...
\item $(\forall s \in S)(\forall\pmb{a}\in\Sigma)\DBAR_{\!\lambda}(s,\pmb{a}) =
	\Lambda( \bigcup\limits_{q\,\in\,\Lambda(s)}\DBAR_{\!\lambda}(q,\pmb{a}))$
...
The nondeterministic finite automaton without $\lambda$-transitions that
corresponds to a nondeterministic finite automaton with $\lambda$-transitions is
given in Definition \ref{dfn-4.9}.

% Figure 4.20
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-20.eps,width=3.5in}}
...
Given a nondeterministic finite automaton with $\lambda$-transitions,
...
Let $A_{\lambda}$ represent the NDFA given in Example 4.14. $A_{\lambda}$ would
...
% Figure 4.21
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-21.eps,width=3.0in}}
...
% Figure 4.22
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-22.eps,width=3.0in}}
...
% Figure 4.23
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-23.eps,width=3.0in}}
...
% Figure 4.24
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-24.eps,width=6.0in}}
...
% Figure 4.25
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig4-25.eps,width=6.0in}}
...
\emph{one} final state that will accept the union of two FAD languages.
...
\item Consider the NDFA which accepts the modified language $L'$ in Example
4.10.
\begin{enumerate}
\item Using the standard encodings, draw a circuit diagram for this NDFA
(include neither \<SOS\> nor \<EOS\>)
