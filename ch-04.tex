...
% Figure 4.1
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig4-1.eps}}
...
% Figure 4.2
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig4-2.eps}}
...
% Figure 4.3
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig4-3.eps}}
...
% Figure 4.4
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig4-4.eps}}
...
t & $\emptyset$ & $\{t\}$
\end{tabular}\end{center}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig4-5.eps}}
...
from $t$ (since $t \not in S_0$), and there is no way to proceed with $x =
...
\[L(A) = \{x \in \Sigma^* \mid (\bigcup\limits_{q\in S_0}
\DBAR(q,x)) \cap F \not= \emptyset\}\]
\end{dfn}
...
% Figure 4.6
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig4-6.eps}}
...
NDFA, valid strings \emph{will} find a way to the final state. It is sometimes
...
While the NDFA given in Example 4.7 is very straightforward, it appears to be
...
% Figure 4.7
\begin{figure}
\centerline{\includegraphics[width=2.8in]{ToFAfigures/fig4-7.eps}}
...
% Figure 4.8
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig4-8.eps}}
...
% Figure 4.9
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig4-9.eps}}
...
% Figure 4.10
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig4-10.eps}}
...
% Figure 4.11
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig4-11.eps}}
...
% Figure 4.12
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig4-12.eps}}
...
% Figure 4.13
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig4-13.eps}}
...
% Figure 4.14
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig4-14.eps}}
...
% Figure 4.15
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig4-15.eps}}
...
% Figure 4.16
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig4-16.eps}}
\caption{The NDFA discussed in Example 4.13}\label{fig-4.16}
\end{figure}
% Figure 4.17
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig4-17.eps}}
...
$t_1$ & $t_2$ & $a_1$ & $a_2$ & $t'_1$ & $t'_2$ & \textbf{accept} \\
\hline
...
% Figure 4.18
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig4-18.eps}}
...
by a circuit diagram as specified in Chapter \ref{ch-1}. This four-state DFA will require
...
\section{NDFAs \textcolor{red}{With} Lambda-Transitions}\label{sec-4.3}
...
% Figure 4.19
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig4-19.eps}}
...
% Figure 4.20
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig4-20.eps}}
...
% Figure 4.21
\begin{figure}
\centerline{\includegraphics[width=3.0in]{ToFAfigures/fig4-21.eps}}
...
% Figure 4.22
\begin{figure}
\centerline{\includegraphics[width=3.0in]{ToFAfigures/fig4-22.eps}}
...
% Figure 4.23
\begin{figure}
\centerline{\includegraphics[width=3.0in]{ToFAfigures/fig4-23.eps}}
...
$\lambda$-transitions, consider the NDFA $E$ given in Figure \ref{fig-4.23}. This machine
...
% Figure 4.24
\begin{figure}
\centerline{\includegraphics[width=6.0in]{ToFAfigures/fig4-24.eps}}
...
% Figure 4.25
\begin{figure}
\centerline{\includegraphics[width=6.0in]{ToFAfigures/fig4-25.eps}}
...
\item Draw the connected part of $T^d$,\textcolor{red}{the} deterministic equivalent of the NDFA
$T$ in Example 4.7.
