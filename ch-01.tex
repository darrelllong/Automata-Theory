...
which there is a finite set of inputs and a finite set of things that must be
...
is what you are reading right now, namely words (or strings) over the
...
Finite automata are appropriate whenever there is a finite number of inputs and
...
that can be thought of as words composed of $\pmb{0}$s and $\pmb{1}$s.
