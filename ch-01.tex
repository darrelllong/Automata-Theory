...
which there \textcolor{red}{are} a finite set of inputs and a finite set of things that must be
...
$\Sigma$ is an \emph{\Index{alphabet}} \ \ \textbf{\emph{iff}} \ \ $\Sigma$ is a finite nonempty set of symbols.
\end{dfn}
...
$\pmb{a}_1\pmb{a}_2\ldots\pmb{a}_n$ is a \emph{word} (or \emph{string}) \emph{over
...
\textcolor{red}{is what you are reading right now, which are} words (or strings) over the
...
\item \textbf{home}$\cdot$\textbf{run} = \textbf{homerun}
\item $\pmb{a}^2\cdot\pmb{b}^3=\pmb{aabbb}$
\end{enumerate}

Example (iii) illustrates a shorthand notation for denoting strings. Placing a
...
Given an alphabet $\Sigma$, and some $\pmb{b} \in \Sigma$, the \emph{length of a word
...
\[\Sigma^k = \{x \ | \ x\text{ is a word over $\Sigma$ and } |x| = k\}\]
\end{dfn}
...
% Figure 1.1
\begin{figure}
%\centerline{\includegraphics[height=2in]{Figures/fig-1-1.eps}}
\centerline{\includegraphics[height=2in]{ToFAfigures/fig1-1.eps}}
...
% Figure 1.2
\begin{figure}
%\centerline{\includegraphics[width=\textwidth]{Figures/fig-1-2.eps}}
\centerline{\includegraphics[width=5in]{ToFAfigures/fig1-2.eps}}
\caption{An implementation of a vending machine}\label{fig-1.2}
\end{figure}

Finite automata are appropriate whenever there \textcolor{red}{are} a finite number of inputs and
...
% Figure 1.3
\begin{figure}
%\centerline{\includegraphics[width=\textwidth]{Figures/fig-1-3.eps}}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig1-3.eps}}
...
\[ (\forall x \in \Sigma^*)(\forall y \in \Sigma^m)(\forall s \in S)
	(\DBAR(s,yx) = \DBAR(\DBAR(s,y),x)), \]
For any $z \in \Sigma^{m+1},(\exists \pmb{a} \in \Sigma^1)(\exists y \in
\Sigma^m) \ni z = \pmb{a}y$. Then
...
% Figure 1.6
\begin{figure}
%\centerline{\includegraphics[width=\textwidth]{Figures/fig-1-6.eps}}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig1-6.eps}}
...
%\centerline{\includegraphics[width=\textwidth]{Figures/fig-1-9.eps}}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig1-9.eps}}
...
\item $\{\lambda\}$
\item \{$\lambda$, \textbf{bilbo}, \textbf{frodo}, \textbf{samwise}\}
...
% Figure 1.11
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig1-11.eps}}
\caption{A DFA that recognizes valid FORTRAN identifiers}\label{fig-1.11}
\end{figure}

% Figure 1.12
\begin{figure}
\centerline{\includegraphics[width=2.7in]{ToFAfigures/fig1-12.eps}}
...
% Figure 1.13
\begin{figure}%]tbh]
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig1-13.eps}}
...
logic circuits are \emph{\Index{logic gates}}; using $\pmb{0}$ or \textbf{False}
to represent a low voltage (ground) and $\pmb{1}$ or \textbf{True} to represent a
...
% Figure 1.15
\begin{figure}
\centerline{\includegraphics[width=4in]{ToFAfigures/fig1-1.eps}}
...
$\pmb{1}$ so that we now have clock $=p'=\neg p=\pmb{1}$, and $p=\pmb{0}$. When the
...
% Figure 1.16
\begin{figure}
\centerline{\includegraphics[width=2.5in]{ToFAfigures/fig1-16.eps}}
...
function for it by $(\forall s \in S)(\delta(s,\<EOS\>) = s)$. Thus, the DFA
...
% Figure 1.17
\begin{figure}
\centerline{\includegraphics[width=5in]{ToFAfigures/fig1-17.eps}}
...
\textcolor{red}{principle} disjunctive normal form of $t_1'$ contains just two terms:
...
% Figure 1.18
\begin{figure}
\centerline{\includegraphics[width=6in]{ToFAfigures/fig1-18.eps}}
...
% Figure 1.19
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig1-19.eps}}
...
a string that ends in $s_0$, so \textbf{accept}$ = 0$ also. The remaining rows are
...
$t_1$ & $t_2$ & $\pmb{a}_1$ & $\pmb{a}_2$ & $t_1'$ & $t_2'$ & \textbf{accept} \\
\hline
...
% Figure 1.20
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig1-20.eps}}
...
% Figure 1.21
\begin{figure}
\centerline{\includegraphics[height=3.8in]{ToFAfigures/fig1-21.eps}}
...
% Figure 1.22
\begin{figure}
\centerline{\includegraphics[width=5.5in]{ToFAfigures/fig1-22.eps}}
...
% Figure 1.23
\begin{figure}
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig1-23.eps}}
...
% Figure 1.24
\begin{figure}[h]
\centerline{\includegraphics[width=6.5in]{ToFAfigures/fig1-24.eps}}
...
that can be thought of as words \textcolor{red}{comprised of} $\pmb{0}$s and $\pmb{1}$s.
...
% Figure 1.25
\begin{figure}
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig1-25.eps}}
...
% Figure 1.26
\begin{figure}[h]
\centerline{\includegraphics[width=3.5in]{ToFAfigures/fig1-26.eps}}
...
&& \textbf{.}\<natural\> & $|$ \\
&& \<sign\>\textbf{.}\<natural\> & $|$ \\
&& \textbf{.}\<natural\>\textbf{E}\<integer\> & $|$ \\
&& \<sign\>\textbf{.}\<natural\>\textbf{E}\<integer\> & $|$ \\
&& \<integer\>\textbf{.}\<natural\> & $|$ \\
&& \<integer\>\textbf{.}\<natural\>\textbf{E}\<integer> & \\
\end{tabular}
\end{center}
...
% Figure 1.27
\begin{figure}
\centerline{\includegraphics[width=5in]{ToFAfigures/fig1-27.eps}}
...
% Figure 1.28
\begin{figure}
\centerline{\includegraphics[width=3in]{ToFAfigures/fig1-28.eps}}
