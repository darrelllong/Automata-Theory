...
take care to explicitly mention the alphabet under consideration.

% Definition 1.1
\begin{dfn}\label{dfn-1.1}
$\Sigma$ is an \Index{alphabet} \emph{iff} $\Sigma$ is a finite nonempty set of symbols.
\end{dfn}
...
the alphabet $\Sigma$ of length $n$} iff for each $i=1,2,\ldots,n,\pmb{a}_1\in
\Sigma$.
\end{dfn}
...
are what you are reading right now, which are words (or strings) over the
...
$|\pmb{242342}|=6$, and $|\pmb{a}_l\pmb{a}_2\pmb{a}_3\pmb{a}_4|=4$.
...
\in\Sigma$. The \em{concatenation} of the strings $x$ and $y$, denoted by $x\cdot y$,
...
Given an alphabet $\Sigma$, and some $b \in \Sigma$, the {\em length of a word
...
$\lambda$ is a string but is not a member of any alphabet:
$\lambda \notin \Sigma$.
...
\[\Sigma^* = \bigcup\limits^\infty_{k=1} \Sigma^k = \Sigma^0 \cup \Sigma^1 \cup
...
\Index{black@\emph{black box} model}. This conceptualization is built around a black box that
...
% Figure 1.1
\begin{figure}
%\centerline{\epsfig{figure=Figures/fig-1-1.eps,height=2in}}
\centerline{\epsfig{figure=ToFAfigures/fig1-1.eps,height=2in}}
...
% Figure 1.2
\begin{figure}
%\centerline{\epsfig{figure=Figures/fig-1-2.eps,width=\textwidth}}
\centerline{\epsfig{figure=ToFAfigures/fig1-2.eps,width=5in}}
...
% Figure 1.3
\begin{figure}
%\centerline{\epsfig{figure=Figures/fig-1-3.eps,width=\textwidth}}
\centerline{\epsfig{figure=ToFAfigures/fig1-3.eps,width=3in}}
...
&\delta(s_1,\pmb{a}) = s_1 &\delta(s_2,\pmb{b}) = s_2 \\
...
% Figure 1.6
\begin{figure}
%\centerline{\epsfig{figure=Figures/fig-1-6.eps,width=\textwidth}}
\centerline{\epsfig{figure=ToFAfigures/fig1-6.eps,width=3in}}
...
%\centerline{\epsfig{figure=Figures/fig-1-9.eps,width=\textwidth}}
\centerline{\epsfig{figure=ToFAfigures/fig1-9.eps,width=3in}}
...
arrow labeled a-z is sufficient to denote all these transitions. Similarly, the
transition labeled $\Sigma$ from $s_7$ indicates that every element of the
alphabet follows the same path.

% Figure 1.11
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-11.eps,width=6.5in}}
\caption{A DFA that recognizes valid FORTRAN identifiers}\label{fig-1.11}
\end{figure}

% Figure 1.12
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-12.eps,width=2.7in}}
...
% Table 1.1
\begin{table}\caption{}\label{tbl-1.1}
...
% Figure 1.13
\begin{figure}%]tbh]
\centerline{\epsfig{figure=ToFAfigures/fig1-13.eps,width=6.5in}}
...
% Figure 1.14
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-14.eps,width=5.7in}}
\begin{center}
\begin{tabular}{ccccc}
...
% Figure 1.15
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-1.eps,width=4in}}
...
only after the high clock pulse is received and will retain that value after the
...
% Figure 1.16
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-16.eps,width=2.5in}}
...
% Figure 1.17
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-17.eps,width=5in}}
...
$s_{\pmb{1}}$ & $\underline{\pmb{1}\ \ \ \ \pmb{0}} = \pmb{c}$ & $s_{\pmb{1}}$
\end{tabular}
}
\end{tabular}\end{center}
...
% Figure 1.18
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-18.eps,width=6in}}
...
% Figure 1.19
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-19.eps,width=3in}}
...
% Figure 1.20
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-20.eps,width=3.5in}}
...
% Figure 1.21
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-21.eps,height=3.8in}}
...
minimal machine. A \emph{\Index{minimal machine}} for a given language is one
...
% Figure 1.22
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-22.eps,width=5.5in}}
...
% Figure 1.23
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-23.eps,width=6.5in}}
...
% Figure 1.24
\begin{figure}[h]
\centerline{\epsfig{figure=ToFAfigures/fig1-24.eps,width=6.5in}}
...
identifying comments in many programming languages. For example, a Pascal
...
in which instructions are executed; \emph{\Index{branch instructions}} allow the
...
presented in this chapter. The receive program starts in a state of waiting for
...
a packet is received, Kermit transitions to the RF state, where it awaits a
...
the abort state, R signifies receive, RF is receive fileheader, and RD is
receive data. Note that unexpected packets (such as a data packet received in
...
% Figure 1.25
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-25.eps,width=3.5in}}
...
% Figure 1.26
\begin{figure}[h]
\centerline{\epsfig{figure=ToFAfigures/fig1-26.eps,width=3.5in}}
...
(at least) two consecutive $\pmb{b}$s $\wedge\ x$ does not contain two
consecutive $\pmb{a}$s\}. Draw a machine that will accept $\Xi$.

\item. The FORTRAN identifier in Example 1.9 recognized all alphabetic
...
% Figure 1.27
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-27.eps,width=5in}}
...
\end{tabular}\end{center}
\item Rigorously prove the statement you made in part (a). \emph{Hint:} First
...
% Figure 1.28
\begin{figure}
\centerline{\epsfig{figure=ToFAfigures/fig1-28.eps,width=3in}}
...
\pmb{-},\pmb{*},\pmb{/}\}$ with two or fewer operators a FAD language? If it
is, draw a machine.
\item Is the set of all postfix expressions over $\{\pmb{A},\pmb{B},\pmb{+},
\pmb{-},\pmb{*},\pmb{/}\}$ with four or fewer operators a FAD language? If it
is, draw a machine.
\item Is the set of all postfix expressions over $\{\pmb{A},\pmb{B},\pmb{+},
\pmb{-},\pmb{*},\pmb{/}\}$ with eight or fewer operators a FAD language? If it
is, draw a machine.
\item Do you think the set of all postfix expressions over $\{\pmb{A},\pmb{B},
\pmb{+},\pmb{-},\pmb{*},\pmb{/}\}$ is a FAD language? Why or why not?
\end{enumerate}
